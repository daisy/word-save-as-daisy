...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
	...
	<xsl:variable name="documentXml"
		...
		<xsl:message>Reading document -  <xsl:value-of select="concat('jar:',$InputFile,'!/word/document.xml')" /></xsl:message>
		<xsl:sequence select="document(concat('jar:',$InputFile,'!/word/document.xml'))" />
	</xsl:variable>
	...
	<xsl:variable name="stylesXml"
		...
		<xsl:message>Reading styles - <xsl:value-of select="concat('jar:',$InputFile,'!/word/styles.xml')" /></xsl:message>
		<xsl:sequence select="document(concat('jar:',$InputFile,'!/word/styles.xml'))" />
	</xsl:variable>
