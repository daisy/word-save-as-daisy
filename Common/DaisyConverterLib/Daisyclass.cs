...
using Sonata.DaisyConverter.DaisyConverterLib.PageStylesValidation;
...
namespace Sonata.DaisyConverter.DaisyConverterLib
{
    class DaisyClass
    {
        ...
        int checkSectionFront = 0, chekTocOccur = 0, pageToc = 1, checkToc = 0;
        int checkSection = 0, checkSectionBody = 0, sectionCounter = 0;
        int noteFlag = 0, incrementPage = 0;
        ...
        /* Constructor which takes the input and output filenames*/
        ...
        /*Function to Push current level value to the stack*/
        ...
        /*Functions to increment the page number*/
            ...
            if (numId != "" && absId != "")
            {
                ...
                switch (((ArrayList)startHeadingItem["List" + tempId])[Convert.ToInt16(iLvl)].ToString())
                {
                    case "Inc":
                        ...
                        {
                            case DaisyClass.emptyListCounter: ((ArrayList)headingCounters["List" + numId])[Convert.ToInt16(iLvl)] = 1;
                                break;
                            default: ((ArrayList)headingCounters["List" + numId])[Convert.ToInt16(iLvl)] = Convert.ToInt16(((ArrayList)headingCounters["List" + numId])[Convert.ToInt16(iLvl)]) + 1;
                                break;
                        }
                        break;

                    default: ((ArrayList)headingCounters["List" + numId])[Convert.ToInt16(iLvl)] = ((ArrayList)startHeadingItem["List" + tempId])[Convert.ToInt16(iLvl)].ToString();
                        break;
                }
